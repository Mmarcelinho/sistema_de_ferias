...
public class LoginFuncionarioErroDesconhecidoTest : IClassFixture<SistemaDeFeriasWebApplicationFactorySemDILoginFuncionario<Program>>
{
    private const string METODOLOGIN = "login/funcionario";

    private readonly HttpClient _client;

    public LoginFuncionarioErroDesconhecidoTest(SistemaDeFeriasWebApplicationFactorySemDILoginFuncionario<Program> factory)
    {
